export const palette = {
  ...
  button: {
    elevated: {
      backgroundStart: "#D4D4D8", // superfície mais clara de destaque
      backgroundEnd: "#52525B", // leve profundidade
      text: "#000000", // contraste máximo

      hoverStart: "#F5F5F5", // leve realce luminoso
      hoverEnd: "#D9D9D9",

      disabledStart: "#E0E0E0", // menos destaque
      disabledEnd: "#CFCFCF",
    },
    primary: {
      background: "#1A1A1A",
